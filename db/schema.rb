...
ActiveRecord::Schema[7.0].define(version: 20_230_811_110_255) do
  ...
  create_table 'incomes_users', id: false, force: :cascade do |t|
    ...
    t.index %w[income_id user_id], name: 'index_incomes_users_on_income_id_and_user_id'
    t.index %w[user_id income_id], name: 'index_incomes_users_on_user_id_and_income_id'
  end
  ...
  create_table 'payments_users', id: false, force: :cascade do |t|
    ...
    t.bigint 'user_id', null: false
    t.index %w[payment_id user_id], name: 'index_payments_users_on_payment_id_and_user_id'
    t.index %w[user_id payment_id], name: 'index_payments_users_on_user_id_and_payment_id'
  end
